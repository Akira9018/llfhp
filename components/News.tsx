...
const newsItems = [
    {
        date: '2026.04.20',
        title: 'マッチングプラットフォーム『UNITY』を2026年5月よりサービス開始します',
        content: '医療機関と介護・福祉施設をつなぐマッチングプラットフォーム『UNITY』を2026年5月より正式にサービス開始いたします。病院のMSW（医療ソーシャルワーカー）が退院支援の問い合わせをオンラインで送信し、施設側がスピーディーに対応可能・不可を返答できる仕組みです。まずは大阪・兵庫エリアより展開し、順次エリアを拡大してまいります。サービスのご利用は招待制となっております。お問い合わせ・お申し込みはこちらのコーポレートサイトからお願いいたします。'
    },
    {
        date: '2024.07.25',
